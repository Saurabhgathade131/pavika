  ...
  return (
    <main className="min-h-screen bg-[#f4f5f9] pb-20">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row items-center py-10 md:py-16 gap-8">
          <div className="w-full md:w-1/2">
            <h1 className="text-4xl md:text-5xl font-black text-[#0b2545] leading-tight mb-4 uppercase tracking-tight">
      ...
      <section id="categories" className="container mx-auto px-4 max-w-7xl pt-12">
        <h2 className="text-2xl font-black text-[#0b2545] mb-6 uppercase tracking-tight">Explore Our Categories</h2>
      ...
      <section className="container mx-auto px-4 max-w-7xl pt-16">
        <h2 className="text-2xl font-black text-[#0b2545] mb-6 uppercase tracking-tight">Our Services</h2>
