...
import { authenticateGoogle, authenticatePhone } from "../actions";
  ...
  return (
    <main className="min-h-screen bg-[#f4f5f9] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md flat-card p-8 text-center border-t-4 border-t-[var(--color-accent)]">
        ...
        {/* Mock Phone Auth Form */}
        <form action={authenticatePhone} className="space-y-6">
        ...
        <form action={authenticateGoogle}>
          <button type="submit" className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-3 px-4 rounded transition-colors flex items-center justify-center gap-2 text-sm">
